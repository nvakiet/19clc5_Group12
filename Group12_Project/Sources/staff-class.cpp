...
//bool importClassCSV() /* <--- Ko can tham so o day, chi nhung ham chay ngam hay tinh toan trong chuong trinh moi can*/ {
...
//	 //Nhu tren, neu da keu nguoi dung nhap vao thi ko can tham so
//	ifstream fin;
//	string path;
//	cin >> path;
//	fin.open(path); //.open(path), vi nguoi dung da nhap duong dan cua minh vao path
//
//	if (!fin.is_open()) {
...
//	int n;
//	//Nen keu nguoi dung tu nhap si so lop n va ten lop de code thuan tien hon, li do se noi o duoi
//	string DoB, sex, ClassID, line;
//	cout << "Enter class ID: ";
//	getline(cin, line);
//	ClassID = line;
...
//	newUser = nullptr;
//
//	fout.open(systemPath + ClassID + fileEx);
//	/*
//	Nap struct Class vao file, dong dau la n
//	*/
//	fout.close();
//
//	return true;
